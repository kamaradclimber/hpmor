...
\chapter{Fichiers Omaké IV, Parallèles alternatifs}
...
\footnotetext{Cette histoire est l'inspiration d'une fanfiction complète écrite par Velorien: \emph{Lighting Up the Dark}.}
...
Le visage d'Aladin était mélancolique mais déterminé alors que l'ancien gamin des rues s'adressait à l'être blue de pur pouvoir pour la dernière fois. Il s'apprêtait à renoncer aux richesses auxquelles il avait brièvement goûtées, pour le bien de son ami: "Génie, voici le troisième -et dernier- souhait. Je souhaite que tu sois--".

La princesse, qui l'avait regardé bouche bée, ne pouvant croire ce qui se passait, parvint enfin à sortir de son ébètement et attrapa la lampe prestement avant qu'il ne puisse terminer la phrase fatidique.

"Attends une seconde", dit Jasmine. "Aladin, mon chéri, tu es mignon mais un peu idiot. As-tu remarqué que lorsque Jafar a subtilisé la lampe, il a eu ses propres souhaits? Génie, je suis que tout le monde reste jeune et bien portant pour toujours. Je souhaite que personne ne meurt jamais sans le désirer. Et enfin je souhaite que l'intelligence de chacun progresse d'un point de Q.I par an". Elle relança la lampe à Aladin. "Maintenant tu peux continuer".
...
\pagebreak[1]
\OmakeIVsection[0.9]{Alice au pays encore plus fou que le nôtre}

Alice lisait à coté de sa sœur au bord de la rivière. Elle était liée avec plusieurs amies plus agées et, si elle le leur demandait poliment, elles étaient ravies de lui prêter des livres dans lesquels les conversations étaient \emph{certainement} moins politiquement correctes poure une fille de son âge.

Les journées chaudes avaient tendance à l'abrutir, Alice avait donc décidé de mouiller son couvrechef et de le placer sur sa nuque. Son esprit vagabondait néanmoins (comme un chaton que sa maîtresse aurait perdu de vue un instant), elle venait de décider que le plaisir de nouer une couronne de paquerettes valait environ environ 4/3 de la pénibilité à se lever et ramasser les paquerettes. Ce qui n'était pas égal au coût d'opportunité d'arrêter de lire son livre bien sûr. Un lapin blanc aux yeux roses interrompit cette réflexion.

Il n'y avait rien de \emph{particulièrement} étonnant; ou du moins, Alice le pensait-elle; à ce que le lapin se murmurait à lui-même: "Ah je suis en retard, ah, je suis en retard!". Mais, lorsque le lapin sortit une montre à gousset de son gilet pour la consulter avant de filer, Alice réalisa qu'elle n'avait jamais vu un lapin porter de gilet, ni en sortir une montre. "Et bien!", se dit-elle par elle-même (ayant perdu la mauvaise habitude de penser tout haut car elle semblait perdre le respect des adultes en le faisant). "Si je réalise pas que ce lapin est plus intriguant que le lapin moyen, alors ma curiosité est probablement affectuée par quelque chose et \emph{ceci} est plus curieux encore". Ansi, se posant toutes ces questions, elle courut après le lapin, juste à temps pour le voir disparaître dans un terrier creusé à flanc de colline.
...
MORPHEUS~: Ça n'existe pas, Néo. L'univers n'est pas sous-tendu par les maths.\\ \end{playdialog}
