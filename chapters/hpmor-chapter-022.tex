...
À nouveau, au bout de la baguette d'Hermione, il y eut l'apparition abrupte et sans transition d'une chauve-souris. Un instant, air. L'instant suivant, chauve-souris. Ses ailes semblaient déjà bouger au moment où elle apparut.
...
«~\emph{Vraiment}~? On doit \emph{vraiment} dire \emph{Oogely boogely}, avec les durées des sons \emph{oo}, \emph{eh} et \emph{ee} ayant un rapport de 3 pour 1 pour 2, ou la chauve-souris ne luira pas~? \emph{Pourquoi}~? \emph{Pourquoi} \emph{? Nom d'une pipe, pourquoi~?}
...
On ne pouvait pas \emph{vraiment} avoir besoin de dire “Wingardium Leviosa” exactement comme il le fallait pour pouvoir faire léviter quelque chose, parce que “Wingardium Leviosa” était vraiment ridicule. L'univers allait-il vérifier que vous aviez dit “Wingardium Leviosa” exactement comme il le fallait et sinon il ne ferait pas voler la plume~?
...
Blondlot avait détruit sa réputation en faisant le genre d'erreur qui vous aurait valu une note exécrable et probablement un rire moqueur de la part de votre chargé de TD dans une classe de première année sur la conception de procédures expérimentales… en 1991.
...
«~Vas-y, dis-le, dit Harry.

--- Je n'allais rien dire, dit la voix sympathique d'Hermione Granger. Ça ne semblait pas être gentil.
...
--- J'ai découvert, dit Harry à travers ses dents serrées, que quand il s'agit de faire des recherches vraiment élémentaires sur un problème réellement déroutant, lorsqu'on n'a pas la moindre idée de ce qui se passe, mes livres sur la méthode scientifique sont de la merde…

--- Surveillez votre langage, M. Potter~! Certains d'entre nous sont d'innocentes jeunes filles~!
...
--- Mmm… d'accord, dit Hermione. Mais j'espérais aussi quelque chose comme “les livres d'Hermione ne sont pas sans valeur. Ils sont écrits par de sages vieux sorciers qui en savent beaucoup plus long sur la magie que moi. Je devrais prêter attention à ce que disent les livres d'Hermione.” On peut aussi avoir cette morale~?~»
...
--- Elle écrit pour \emph{La Gazette du sorcier,}~» dit Drago. Il essaya de ne pas paraître soucieux. La \emph{Gazette du sorcier} était l'un des principaux outils de Père, il l'utilisait comme il aurait usé d'une baguette magique. «~C'est le journal auquel les gens prêtent vraiment attention. Rita Skeeter parle des célébrités, et comme elle le dit, elle utilise sa plume pour \emph{crever leurs réputations surfaites}. Si elle ne peut pas trouver de rumeur te concernant, elle s'en fabriquera une.

--- Je vois~», dit Harry Potter. Sous la houppelande, son visage verdâtre semblait fort pensif.

Drago hésita quant à ce qu'il devait dire ensuite. Quelqu'un devait déjà avoir informé Père du fait qu'il voulait se rapprocher de Harry Potter, et Père saurait aussi que Drago ne lui en avait pas parlé dans ses lettres, et Père comprendrait que Drago ne pensait pas qu'il pouvait réellement garder ça secret, ce qui envoyait un message clair disant que Drago jouait à son propre jeu, mais toujours du côté de Père, puisque si Drago avait succombé à cette tentation, il aurait envoyé de faux rapports.
...
«~Harry, dit enfin Drago. Ce n'est pas une suggestion. Ce n'est pas mon conseil. C'est juste une information. Mon père pourrait presque certainement étouffer cet article. Mais ca ne serait pas gratuit.~»
...
Un air inquiet apparut sur le visage de Drago avant qu'il ne puisse l'en empêcher. Quel que soit le prochain coup de Harry, c'était quelque chose auquel Père ne s'attendait pas, et cela rendait Drago très nerveux d'imaginer où ça pourrait mener.
...
\penalty-10
\begin{writtenNote}
Observation~: La sorcellerie n'est pas aussi puissante qu'elle ne l'était quand Poudlard a été fondée. \penalty101
...
\item Les sorciers plus puissants ont moins d'enfants (Drago = fils unique~? Vérifier si trois sorciers puissants, Quirrell / Dumbledore / Seigneur des Ténèbres ont eu des enfants). \end{enumerate}
Tests~:~ ...
...
--- Répète~», dit Drago quand il eut fini d'écrire, et Harry répéta.
