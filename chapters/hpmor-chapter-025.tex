...
«~Excusez-moi~», dit une voix familière venant de dernière lui, parlant d'un ton peu habituel. «~Au moment qui vous siéra, M. Malfoy demande la faveur d'une conversation.~»
...
Le long tunnel étroit taillé dans la pierre brute semblait s'étirer sur des kilomètres. Il aurait été parfaitement obscur sans la baguette d'un enfant.
...
\translatorsnotetext{J'utilise le mot anglais \emph{sentient} à la façon de Guy Abadia dans l'Étoile et le Fouet.}
