\chapter{Fichiers Omaké 1, 2 et 3}
\translatorsnotetext{mot japonais signifiant "extra" ou "bonus". On les trouve souvent dans les DVD d'anime japonais avec un ton humoristique, se moquant du contenu principal.}

\iftoggle{embedepigraphs}{\input{epigraphs/epigraph11.tex}}{}

\section{Fichier Omaké I}

Dumbledore se pencha au-dessus de son bureau en direction du jeune Harry, il émanait de lui une douce gentillesse. Le garçon était venu le voir avec un air d'une terrible intensité peint sur son visage enfantin -- Dumbledore espérait que, quelle que soit l'affaire qui le préoccupait, ce ne fut pas \emph{trop} sérieux. Harry était bien trop jeune pour que les épreuves de sa vie ne commencent déjà. «~De quoi souhaitais-tu me parler, Harry~?~»
...
\begin{center}
\emph{Je n'ai pas peur des Seigneurs des Ténèbres~!}\footnotemark
\end{center}
\translatorsnotetext{Traduction un peu littérale de \emph{I ain't afraid of no ghost} de la chanson \emph{Ghostbusters}}
...
«~ROOT~!~»\footnotemark
\translatorsnotetext{Root est le nom du super-utilisateur sur les systèmes Unix. Devenir \emph{root} sur une machine est l'objectif d'un hacker. Ce que fait Harry s'appelle une élévation des privilèges.}
