...
C'est le salon de la maison où vivent l'éminent professeur Michael Verres-Evans, sa femme Pétunia Evans-Verres et leur fils adoptif~: Harry James Potter-Evans-Verres.

Il y a une lettre sur la table du salon, et une enveloppe sans timbre faite d'un parchemin jaunâtre, adressées à un \emph{M. H. Potter} d'une encre vert-émeraude.
...
Harry avait parfois envie de hurler contre son père.
...
\letterAddress{Ou à toute personne concernée~:}
...
\letterClosing[Bien à vous,]{Harry James Potter-Evans-Verres.}
\end{writtenNote}
