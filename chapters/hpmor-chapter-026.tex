...
Harry se sentait \emph{terriblement} curieux, mais ça aurait gaché cette \emph{œuvre d'art} en l'entendant de seconde main.
...
(\emph{Ça n'arrivait tout simplement jamais dans l'environnement préhistorique}, se plaignit son cerveau, et il le désorienta.)
...
--- \emph{Chuut}~! Désolé, j'ai attendu toute la journée pour pouvoir lire la nouvelle dans le journal au lieu de l'entendre de seconde main, alors s'il vous plaît, donnez-le-moi, d'accord~?~»
...
C'était le meilleur restaurant où Harry avait été, et le fait que le professeur Quirrell était celui qui invitait l'embêtait vraiment.

La première partie de la mission consistait à trouver un précepteur d'Occlumancie et cela avait été un succès. Le professeur Quirrell, en souriant d'un air démoniaque, avait dit à Gripsec de recommander le meilleur qu'il connaisse et de ne pas se soucier des dépenses puisque c'était Dumbledore qui payait~; et le Gobelin avait souri en retour. Il y avait peut-être aussi eu quelques sourires du côté de Harry.
